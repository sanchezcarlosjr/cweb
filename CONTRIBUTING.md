...
Welcome to `cWeb` contributor's guide.
...
If you experience bugs or general issues with `cWeb`, please have a look
...
You can help improve `cWeb` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cWeb` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cWeb`'s files. While this mechanism can
...
```
conda create -n cWeb python=3 six virtualenv pytest pytest-cov
conda activate cWeb
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cWeb.git
   cd cWeb
   ```
...
5. Install [pre-commit]:
   ...
   `cWeb` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cWeb
[issue tracker]: https://github.com/<USERNAME>/cWeb/issues
